...
| **IA** | Anthropic SDK + truststore | 0.69 / 0.10.4 (`backend/app/chatbot.py:22`) |
...
- **Git**: `main` único branch, 3 commits iniciais (`project commit`, `QoL`) — PT-BR curtos, sem Conventional Commits. Sem PR workflow detectado.
